                    ...
                    <div class="layui-form layui-form-pane layui-tab-item layui-show">
                        <form method="post">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-form-mid layui-word-aux">If you have changed the e-mail address,<a href="activate.html" style="font-size: 12px; color: #4f99cf;">Re-validate e-mail address</a></div>
                            </div>
                            <div class="layui-form-item">
